...
L298NMotorShield::L298NMotorShield()
{
  //Pin map
  _INA1 = 2;
  _INB1 = 4;
...
L298NMotorShield::L298NMotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
...
void L298NMotorShield::setM1Speed(int speed)
{
...
void L298NMotorShield::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void L298NMotorShield::setSpeeds(int m1Speed, int m2Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
}
...
void L298NMotorShield::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void L298NMotorShield::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void L298NMotorShield::setBrakes(int m1Brake, int m2Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
}
...
unsigned int L298NMotorShield::getM1CurrentMilliamps()
{
...
unsigned int L298NMotorShield::getM2CurrentMilliamps()
{
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char L298NMotorShield::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char L298NMotorShield::getM2Fault()
{
